    ...
    def getAllPagesInTheBoard(self):
        ...
        try:
            if (self.useHeader):
                ...
                indexPage = bs4.BeautifulSoup(urllib2.urlopen(request).read(), "html5lib")
            else:
                indexPage = bs4.BeautifulSoup(urllib2.urlopen(self.ESPECIAL_URL).read(), "html5lib")
        ...
        for indexP in xrange(startIndex, endIndex):
            ...
            try:
                if (self.useHeader): ## if the page require header 
                    ...
                    page = bs4.BeautifulSoup(urllib2.urlopen(request).read(), "html5lib")
                else:
                    page = bs4.BeautifulSoup(urllib2.urlopen(self.page_url(indexP)).read(), "html5lib")
            except:
            ...
            for link in page.find_all(class_='r-ent'):
                ...
                try:
                    ...
                    if (self.useHeader): ## if the page require header 
                        ...
                        post = bs4.BeautifulSoup(urllib2.urlopen(request).read(), "html5lib")
                    else:
                        post = bs4.BeautifulSoup(urllib2.urlopen(self.post_url(post_id)).read(), "html5lib")
                except:
